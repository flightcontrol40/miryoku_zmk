...
U_LMT(LGUI, Q),    U_LMT(LALT, S),    U_LMT(LCTRL, D),   U_LMT(LSHFT, F),   &kp G,             &kp H,             U_RMT(LSHFT, J),   U_RMT(LCTRL, K),   U_RMT(LALT, L),    U_RMT(LGUI, M),    \
U_LT(U_BUTTON, W), U_LMT(RALT, X),    &kp C,             &kp V,             &kp B,             &kp N,             &kp COMMA,         &kp DOT,           U_LMT(RALT, SLASH),U_LT(U_BUTTON, SQT),\
...
U_LMT(LGUI, Y),    U_LMT(LALT, I),    U_LMT(LCTRL, E),   U_LMT(LSHFT, A),   &kp DOT,           &kp D,             U_RMT(LSHFT, S),   U_RMT(LCTRL, T),   U_RMT(LALT, N),    U_RMT(LGUI, B),    \
U_LT(U_BUTTON, J), U_LMT(RALT, SLASH),&kp COMMA,         &kp K,             &kp SQT,           &kp W,             &kp M,             &kp L,             U_LMT(RALT, P),    U_LT(U_BUTTON, V), \
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAK_FLIP \
&kp Q,             &kp W,             &kp F,             &kp P,             &kp G,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
U_LMT(LGUI, A),    U_LMT(LALT, R),    U_LMT(LCTRL, S),   U_LMT(LSHFT, T),   &kp D,             &kp H,             U_RMT(LSHFT, N),   U_RMT(LCTRL, E),   U_RMT(LALT, I),    U_RMT(LGUI, O),    \
U_LT(U_BUTTON, Z), U_LMT(RALT, X),    &kp C,             &kp V,             &kp B,             &kp K,             &kp M,             &kp COMMA,         U_LMT(RALT, DOT),  U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP
...
U_LT(U_BUTTON, Z), U_LMT(RALT, X),    &kp C,             &kp D,             &kp V,             &kp K,             &kp H,             &kp COMMA,         U_LMT(RALT, DOT),  U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDHK_FLIP \
&kp Q,             &kp W,             &kp F,             &kp P,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
U_LMT(LGUI, A),    U_LMT(LALT, R),    U_LMT(LCTRL, S),   U_LMT(LSHFT, T),   &kp G,             &kp K,             U_RMT(LSHFT, N),   U_RMT(LCTRL, E),   U_RMT(LALT, I),    U_RMT(LGUI, O),    \
U_LT(U_BUTTON, Z), U_LMT(RALT, X),    &kp C,             &kp D,             &kp V,             &kp M,             &kp H,             &kp COMMA,         U_LMT(RALT, DOT),  U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_DVORAK_FLIP \
&kp SQT,           &kp COMMA,         &kp DOT,           &kp P,             &kp Y,             &kp F,             &kp G,             &kp C,             &kp R,             &kp L,             \
U_LMT(LGUI, A),    U_LMT(LALT, O),    U_LMT(LCTRL, E),   U_LMT(LSHFT, U),   &kp I,             &kp D,             U_RMT(LSHFT, H),   U_RMT(LCTRL, T),   U_RMT(LALT, N),    U_RMT(LGUI, S),    \
U_LT(U_BUTTON, SLASH),U_LMT(RALT, Q),    &kp J,             &kp K,             &kp X,             &kp B,             &kp M,             &kp W,             U_LMT(RALT, V),    U_LT(U_BUTTON, Z), \
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_HALMAK_FLIP \
&kp W,             &kp L,             &kp R,             &kp B,             &kp Z,             &kp SQT,           &kp Q,             &kp U,             &kp D,             &kp J,             \
U_LMT(LGUI, S),    U_LMT(LALT, H),    U_LMT(LCTRL, N),   U_LMT(LSHFT, T),   &kp COMMA,         &kp DOT,           U_RMT(LSHFT, A),   U_RMT(LCTRL, E),   U_RMT(LALT, O),    U_RMT(LGUI, I),    \
U_LT(U_BUTTON, F), U_LMT(RALT, M),    &kp V,             &kp C,             &kp SLASH,         &kp G,             &kp P,             &kp X,             U_LMT(RALT, K),    U_LT(U_BUTTON, Y), \
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_WORKMAN_FLIP \
&kp Q,             &kp D,             &kp R,             &kp W,             &kp B,             &kp J,             &kp F,             &kp U,             &kp P,             &kp SQT,           \
U_LMT(LGUI, A),    U_LMT(LALT, S),    U_LMT(LCTRL, H),   U_LMT(LSHFT, T),   &kp G,             &kp Y,             U_RMT(LSHFT, N),   U_RMT(LCTRL, E),   U_RMT(LALT, O),    U_RMT(LGUI, I),    \
U_LT(U_BUTTON, Z), U_LMT(RALT, X),    &kp M,             &kp C,             &kp V,             &kp K,             &kp L,             &kp COMMA,         U_LMT(RALT, DOT),  U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTY_FLIP \
&kp Q,             &kp W,             &kp E,             &kp R,             &kp T,             &kp Y,             &kp U,             &kp I,             &kp O,             &kp P,             \
U_LMT(LGUI, A),    U_LMT(LALT, S),    U_LMT(LCTRL, D),   U_LMT(LSHFT, F),   &kp G,             &kp H,             U_RMT(LSHFT, J),   U_RMT(LCTRL, K),   U_RMT(LALT, L),    U_RMT(LGUI, SQT),  \
U_LT(U_BUTTON, Z), U_LMT(RALT, X),    &kp C,             &kp V,             &kp B,             &kp N,             &kp M,             &kp COMMA,         U_LMT(RALT, DOT),  U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTZ_FLIP \
&kp Q,             &kp W,             &kp E,             &kp R,             &kp T,             &kp Z,             &kp U,             &kp I,             &kp O,             &kp P,             \
U_LMT(LGUI, A),    U_LMT(LALT, S),    U_LMT(LCTRL, D),   U_LMT(LSHFT, F),   &kp G,             &kp H,             U_RMT(LSHFT, J),   U_RMT(LCTRL, K),   U_RMT(LALT, L),    U_RMT(LGUI, SQT),  \
U_LT(U_BUTTON, Y), U_LMT(RALT, X),    &kp C,             &kp V,             &kp B,             &kp N,             &kp M,             &kp COMMA,         U_LMT(RALT, DOT),  U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_FUN, DEL),  U_LT(U_NUM, BSPC), U_LT(U_SYM, RET),  U_LT(U_MOUSE, TAB),U_LT(U_NAV, SPACE),U_LT(U_MEDIA, ESC),U_NP,              U_NP
